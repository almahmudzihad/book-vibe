    ...
    <div className="max-w-6xl mx-auto px-4 py-10">
      <div className="grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div className="bg-gray-50 rounded-xl p-8 flex justify-center">
          <img src={image} alt={bookName} className="w-64 object-contain" />
        </div>
        ...
        <div className="space-y-5">
          {/* Title */}
          <div>
            <h1 className="text-3xl font-semibold text-gray-800">{bookName}</h1>
            <p className="text-gray-500 mt-1">by {author}</p>
          </div>

          {/* Category */}
          <p className="text-sm text-gray-600 border-b pb-3">{category}</p>
          ...
          <div className="flex gap-4 pt-5">
            <button
              ...
              className="px-6 py-2 bg-white border border-gray-300 text-gray-800 rounded-md text-sm hover:bg-sky-500 hover:text-white transition"
            >
              Mark as Read
            </button>
            ...
            <button
              ...
              className="px-6 py-2 bg-white border border-gray-300 rounded-md text-sm hover:bg-sky-500 hover:text-white transition"
            >
              Add to Wishlist
            </button>
          </div>
